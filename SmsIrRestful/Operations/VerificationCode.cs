...
namespace SmsIrRestful
{
    public class VerificationCode
    {
        ...
        /// <summary>
        /// send your site verification code using this method . just notice that module purchase is needed
        /// </summary>
        /// <param name="tokenKey"> see GetToken method in  <see cref="Token"/> class </param>
        /// <param name="model">is is an object of <see cref="RestVerificationCode "/></param>
        /// <returns>returns an object of <see cref="RestVerificationCodeRespone"/></returns>
